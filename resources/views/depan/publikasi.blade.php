                                ...
                                <div class="col-lg-10">
                                    <div class="post-content">
                                        ...
                                        <div style="margin-top:10px;">
                                            ...
                                            @if ($brt->berkas != '')
                                            <a href="javascript:void(0)" class="btn btn-sm btn-3d btn-primary mb-2" data-bs-toggle="modal" data-bs-target="#modalku" onclick="showFormRead('{{ $brt->id_publikasi }}', '{{ Request::segment(1) }}')">
