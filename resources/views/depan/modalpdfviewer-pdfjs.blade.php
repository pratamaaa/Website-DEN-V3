<link rel="resource" type="application/l10n" href="{{ asset('plugins/pdfjs/web/locale/locale.properties') }}">
<script src="{{ asset('plugins/pdfjs/build/pdf.js') }}"></script>
<link rel="stylesheet" href="{{ asset('plugins/pdfjs/web/viewer.css') }}">
<script src="{{ asset('plugins/pdfjs/web/viewer.js') }}"></script>
<script>
    window.addEventListener('load', function() {
        PDFViewerApplication.open("<?=asset('/uploads/publikasi/perda_no_4_tahun_2020_tentang_rued_provinsi_sumsel.pdf')?>")
        // PDFViewerApplication.open("perpres-nomor-22-tahun-2017-rencana-umum-energi-nasional.pdf")
    });
</script>
