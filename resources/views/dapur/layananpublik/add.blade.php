        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group mb-1">
                    ...
                    <input type="input" class="form-control form-control-sm" id="nama_layananpublik" name="nama_layananpublik" style="width: 100%;">
                </div>
                <div class="form-group mb-1">
                    <label class="labelku" style="color: #626365;font-size:13px;"><b>Nama layanan publik (EN):</b></label>
                    <input type="input" class="form-control form-control-sm" id="nama_layananpublik_en" name="nama_layananpublik_en" style="width: 100%;">
                </div>
                <div class="form-group mb-1">
                ...
                <div class="form-group mb-1">
                    ...
                    <input type="input" class="form-control form-control-sm" id="alamat_url" name="alamat_url" style="width: 100%;" placeholder="https://alamaturl.com">
                </div>
                <div class="form-group mb-1">
                    <label class="labelku" style="color: #626365;font-size:13px;"><b>Icon:</b></label>
                    <input type="input" class="form-control form-control-sm" id="icon" name="icon" style="width: 100%;" placeholder="home">
...
<script type="text/javascript">
    ...
    $.validator.setDefaults({
      submitHandler: function(){
        ...
        $.ajax({
            url: "{{ url('/dap/layananpublik/save') }}",
            type: 'POST',
