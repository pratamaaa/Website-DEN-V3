        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group mb-1">
                    ...
                    <input type="input" class="form-control form-control-sm" id="judul_slider" name="judul_slider" style="width: 100%;">
                </div>
                <div class="form-group mb-1">
                    <label class="labelku" style="color: #626365;font-size:13px;"><b>Alamat URL:</b></label>
                    <input type="input" class="form-control form-control-sm" id="alamat_url" name="alamat_url" style="width: 100%;">
                </div>
                <div class="form-group mb-1">
