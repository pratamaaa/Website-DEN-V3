        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group mb-1">
                    <label class="labelku" style="color: #626365;font-size:13px;"><b>Judul slider:</b></label>
                    <input type="input" class="form-control form-control-sm" value="{{ $data->judul_slider }}" id="judul_slider" name="judul_slider" style="width: 100%;">
                    <input type="hidden" class="form-control form-control-sm" value="{{ $data->id_image_slider }}" id="id_imageslider" name="id_imageslider" style="width: 100%;">
                </div>
                <div class="form-group mb-1">
                    <label class="labelku" style="color: #626365;font-size:13px;"><b>Alamat URL:</b></label>
                    <input type="input" class="form-control form-control-sm" value="{{ $data->alamat_url }}" id="alamat_url" name="alamat_url" style="width: 100%;">
                </div>
                <div class="form-group mb-1">
                    ...
                    <input type="hidden" class="form-control form-control-sm" value="{{ $data->gambar }}" id="gambar_current" name="gambar_current" style="width: 60%;margin-bottom:5px;">
                    @if ($data->gambar != "")
                        <img src="{{ asset('uploads/imagesliders/'.$data->gambar) }}" width="150px" style="margin-top:10px;border-radius:5px;border:1px solid #cdcdcd;">
                    @else
                ...
                <div class="form-group mb-1 mt-3">
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="is_active" name="is_active" {{ $data->is_active == 'yes' ? 'checked' : '' }}>
...
<script type="text/javascript">
    ...
    $.validator.setDefaults({
      submitHandler: function(){
        ...
        $.ajax({
            url: "{{ url('/dap/imageslider/saveupdate') }}",
            type: 'POST',
