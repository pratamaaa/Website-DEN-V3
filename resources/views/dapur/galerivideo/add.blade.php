        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group mb-1">
                    ...
                    <input type="input" class="form-control form-control-sm" id="judul_video" name="judul_video" style="width: 100%;">
                </div>
                <div class="form-group mb-1">
                ...
                <div class="form-group mb-1">
                    ...
                    <input type="input" class="form-control form-control-sm" id="youtube_id" name="youtube_id" style="width: 100%;" placeholder="rzvUbAEEOak">
                </div>
                <div class="form-group mb-1">
