    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="form-group mb-1">
                ...
                <textarea class="form-control summernote" id="isi_berita" name="isi_berita" rows="5"></textarea>
            </div>
            <div class="form-group" style="margin-top:-20px !important;margin-bottom:-20px !important;">
	            ...
	            <textarea class="form-control summernote" id="isi_berita_en" name="isi_berita_en" rows="5"></textarea>
            </div>
            <div class="form-group mb-1">
