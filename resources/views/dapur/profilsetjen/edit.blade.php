<style>
            ...
            <div class="col-md-12">
                ...
                <div class="form-group mb-1 mt-3">
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="is_konten_gambar" name="is_konten_gambar" {{ $data->is_konten_gambar == "yes" ? "checked" : "" }}> 
                ...
                <div class="form-group mb-1">
                    ...
                    <input type="hidden" class="form-control form-control-sm" value="{{ $data->konten_gambar }}" id="gambar_current" name="gambar_current" style="width: 40%;">
                    
                    @if ($data->konten_gambar != "")
                        <img src="{{ asset('uploads/profilden/'.$data->konten_gambar) }}" width="150px" style="margin-top:10px;border-radius:5px;border:1px solid #cdcdcd;">
                    @else
                ...
                <div class="form-group mb-1">
                    ...
                    <select class="form-control" id="is_active" name="is_active" style="width: 20%;">
                        <option value="yes" @if ($data->is_active == 'yes') selected @endif>Ya</option>
                        <option value="no" @if ($data->is_active == 'no') selected @endif>Tidak</option>
                    </select>
                </div>
            </div>
    ...
    $.validator.setDefaults({
      submitHandler: function(){
        ...
        $.ajax({
            url: "{{ url('/dap/profilsetjen/saveupdate') }}",
            type: 'POST',
