        ...
        <div class="row">
            <div class="col-md-12">
                        ...
                        <select class="form-control" id="kategori_jabatan" name="kategori_jabatan" style="width: 90%;">
                            @if ($kategori->count() != 0)
                                @foreach ($kategori->get() as $kat)
                                    @if ($kat->kategori_organisasi == $data->kategori_jabatan)
                                    <option value="{{ $kat->kategori_organisasi }}" selected>{{ $kat->nama_kategori }}</option>
                                    @else
                ...
                <div class="form-group mb-1">
                    ...
                    <input type="input" class="form-control form-control-sm" value="{{ $data->namalengkap }}" id="namalengkap" name="namalengkap" style="width: 100%;">
                    <input type="hidden" class="form-control form-control-sm" value="{{ $data->id_organisasiden }}" id="id_organisasiden" name="id_organisasiden" style="width: 100%;">
                </div>
                <div class="form-group mb-1">
                    <label class="labelku" style="color: #626365;font-size:13px;"><b>Jabatan:</b></label>
                    <input type="input" class="form-control form-control-sm" value="{{ $data->jabatan }}" id="jabatan" name="jabatan" style="width: 100%;">
                </div>
                <div class="form-group mb-1">
                    <label class="labelku" style="color: #626365;font-size:13px;"><b>Jabatan (EN):</b></label>
                    <input type="input" class="form-control form-control-sm" value="{{ $data->jabatan_en }}" id="jabatan_en" name="jabatan_en" style="width: 100%;">
                </div>
                <div class="form-group mb-1">
                    ...
                    <input type="hidden" class="form-control form-control-sm" value="{{ $data->foto }}" id="gambar_current" name="gambar_current" style="width: 40%;">
                </div>
                <div class="form-group mb-1">
                    <label class="labelku" style="color: #626365;font-size:13px;"><b>Periode:</b></label>
                    <input type="input" class="form-control form-control-sm" value="{{ $data->periode }}" id="periode" name="periode" style="width: 100%;">
                </div>
                <div class="form-group mb-1">
                    <label class="labelku" style="color: #626365;font-size:13px;"><b>Profil:</b></label>
                    <textarea class="form-control summernote" id="profil" name="profil" rows="3">{{ $data->profil }}</textarea>
                </div>
                <div class="form-group mb-1" style="margin-top:-20px !important;margin-bottom:-20px !important;">
                    <label class="labelku" style="color: #626365;font-size:13px;"><b>Profil (EN):</b></label>
                    <textarea class="form-control summernote" id="profil_en" name="profil_en" rows="3">{{ $data->profil_en }}</textarea>
                </div>
                <div class="form-group mb-1">
...
<script type="text/javascript">
    ...
    $.validator.setDefaults({
      submitHandler: function(){
        ...
        $.ajax({
            url: "{{ url('/dap/organisasiden/saveupdate') }}",
            type: 'POST',
