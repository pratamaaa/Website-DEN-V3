<style>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group mb-1">
                    <label class="labelku" style="color: #626365;font-size:13px;"><b>Kategori berita</b></label>
                    <input type="input" value="{{ $data->kategori_berita }}" class="form-control form-control form-control-sm" id="kategori_berita" name="kategori_berita" style="width: 100%;">
                    <input type="hidden" value="{{ $data->id_berita_kategori }}" class="form-control form-control form-control-sm" id="id_kategori_berita" name="id_kategori_berita" style="width: 100%;">
                </div>
                <div class="form-group mb-1">
                    <label class="labelku" style="color: #626365;font-size:13px;"><b>Kategori berita (en)</b></label>
                    <input type="input" value="{{ $data->kategori_berita_en }}" class="form-control form-control form-control-sm" id="kategori_berita_en" name="kategori_berita_en" style="width: 100%;">
                </div>
                <div class="form-group">
                    <label class="labelku" style="color: #626365;font-size:13px;"><b>Slug</b></label>
                    <input type="input" value="{{ $data->kategori_slug }}" class="form-control form-control form-control-sm" id="slug" name="slug" style="width: 100%;">
                </div>
            </div>
    ...
    $.validator.setDefaults({
      submitHandler: function(){
        ...
        $.ajax({
            url: '{{ url('/kategoriberita/saveupdate') }}',
            type: 'POST',
