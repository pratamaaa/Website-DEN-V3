<style>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group mb-1">
                    ...
                    <input type="input" class="form-control form-control form-control-sm" value="{{ $data->informasipublik }}" id="informasipublik" name="informasipublik" style="width: 100%;">
                    <input type="hidden" class="form-control form-control form-control-sm" value="{{ $data->id_informasipublik }}" id="id_informasipublik" name="id_informasipublik" style="width: 100%;">
                </div>
                <div class="form-group mb-1">
                    ...
                    <select class="form-control" id="jenis" name="jenis" style="width: 40%;">
                        ...
                        @else
                            ...
                            <option value="tautan" selected>Tautan</option>
                        @endif
                    </select>
                </div>
                <div class="form-group mb-1">
                    <label class="labelku" style="color: #626365;font-size:13px;"><b>Alamat URL:</b></label>
                    <input type="input" class="form-control form-control form-control-sm" value="{{ $data->alamat_url }}" id="alamat_url" name="alamat_url" style="width: 100%;">
                </div>
                <div class="form-group mb-1">
                    ...
                    <select class="form-control" id="group" name="group" style="width: 40%;">
                        ...
                        @else
                            ...
                            <option value="informasipublik" selected>Informasi Publik</option>
                        @endif
                    </select>
                </div>
                <div class="form-group">
                    <label class="labelku" style="color: #626365;font-size:13px;"><b>Urutan:</b></label>
                    <input type="input" class="form-control form-control form-control-sm" value="{{ $data->urutan }}" id="urutan" name="urutan" style="width: 30%;">
                </div>
    ...
    $.validator.setDefaults({
      submitHandler: function(){
        ...
        $.ajax({
            url: '{{ url('/dap/infopublik-grouping/saveupdate') }}',
            type: 'POST',
