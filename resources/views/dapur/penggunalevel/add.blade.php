    ...
    <div class="row">
        <div class="col-md-12">
            <div class="form-group mb-1">
	            ...
	            <input type="input" class="form-control form-control-sm" id="level" name="level" style="width: 100%;">
            </div>
            <div class="form-group mb-1">
                <label class="labelku" style="color: #626365;font-size:13px;"><b>Deskripsi:</b></label>
                <textarea class="form-control summernote" id="keterangan" name="keterangan" rows="5"></textarea>
            </div>
        </div>
...
$.validator.setDefaults({
  submitHandler: function(){
    ...
    $.ajax({
        url: "{{ url('/dap/levelpengguna/save') }}",
        type: 'POST',
