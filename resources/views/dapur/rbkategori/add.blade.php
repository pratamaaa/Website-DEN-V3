    ...
    <div class="row">
        <div class="col-md-12">
            <div class="form-group mb-1">
	            ...
	            <input type="input" class="form-control form-control form-control-sm" id="nama_rbkategori" name="nama_rbkategori" style="width: 100%;">
            </div>
            <div class="form-group mb-1">
                <label class="labelku" style="color: #626365;font-size:13px;"><b>Kategori berita (en)</b></label>
	            <input type="input" class="form-control form-control form-control-sm" id="nama_rbkategori_en" name="nama_rbkategori_en" style="width: 100%;">
            </div>
