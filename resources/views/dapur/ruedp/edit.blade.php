        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group mb-1">
                    ...
                    <input type="input" class="form-control form-control-sm" value="{{ $data->status_penyusunan }}" id="status_penyusunan" name="status_penyusunan" style="width: 100%;">
                    <input type="hidden" class="form-control form-control-sm" value="{{ $data->id_ruedp }}" id="id_ruedp" name="id_ruedp" style="width: 100%;">
                </div>
                <div class="form-group mb-1">
                    <label class="labelku" style="color: #626365;font-size:13px;"><b>Jumlah provinsi:</b></label>
                    <input type="input" class="form-control form-control-sm" value="{{ $data->jumlah_provinsi }}" id="jumlah_provinsi" name="jumlah_provinsi" style="width: 30%;">
                </div>
                <div class="form-group mb-1">
                    <label class="labelku" style="color: #626365;font-size:13px;"><b>Daftar provinsi:</b></label>
                    <textarea class="form-control summernote" id="daftar_provinsi" name="daftar_provinsi" rows="3">{{ $data->daftar_provinsi }}</textarea>
                </div>
                <div class="form-group mb-1">
                    ...
                    <div class="datepicker date input-group" style="width:200px;">
                      <input type="text" placeholder="Pilih tanggal" value="{{ $data->pertanggal }}" class="form-control" id="pertanggal" name="pertanggal">
                ...
                <div class="form-group mb-1">
                    ...
                    <input type="text" class="form-control form-control-sm" value="{{ $data->urutan }}" id="urutan" name="urutan" style="width: 30%;">
                </div>
            </div>
