        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group mb-1">
                    ...
                    <input type="input" class="form-control form-control-sm" value="{{ $data->judul_infografis }}" id="judul_infografis" name="judul_infografis" style="width: 100%;">
                    <input type="hidden" class="form-control form-control-sm" value="{{ $data->id_infografis }}" id="id_infografis" name="id_infografis" style="width: 100%;">
                </div>
                <div class="form-group mb-1">
                    ...
                    @if ($data->gambar_sampul != "")
                        <img src="{{ asset('uploads/infografis/'.$data->gambar_sampul) }}" width="150px" style="margin-top:10px;border-radius:5px;border:1px solid #cdcdcd;">
                    @else
                ...
                <div class="form-group mb-1" id="div_berkas">
                    ...
                    {{-- <a href="#"> --}}
                    <a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#modalku" onclick="showFormRead('{{ $data->id_infografis }}', 'infografis')">
